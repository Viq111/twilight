...
import termcolor
import client_api
import minmax_python as minmax
...
cdef int flight_distance(int startx, int starty, int stopx, int stopy):
...
cdef class BoardGame:
    "Create a simuation of the board game"

    cdef public int nplayer
    cdef public object p1_obj
    cdef public object p2_obj
    cdef public object free_objectives
